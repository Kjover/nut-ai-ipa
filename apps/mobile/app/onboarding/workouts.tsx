...
export default function WorkoutsScreen() {
  return (
    <OptionScreen
      ...
      options={[
        { value: '0-2', label: '0-2', sublabel: 'Workouts now and then', glyph: '•' },
        { value: '3-5', label: '3-5', sublabel: 'A few workouts per week', glyph: '⁙' },
        { value: '6+', label: '6+', sublabel: 'Dedicated athlete', glyph: '⣿' },
      ]}
    />
  )
}
